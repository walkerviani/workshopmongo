...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Let’s hit the road!", "I’m heading to New York. Bye!!", maria);
        Post post2 = new Post(null, sdf.parse("23/03/2018"), "Good morning", "I'm in a happy mood today", maria);
